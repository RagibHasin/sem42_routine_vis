...
var Elective1;
(function (Elective1) {
    Elective1["eee4141"] = "eee4141";
    Elective1["eee4165"] = "eee4165";
})(Elective1 || (Elective1 = {}));
var Elective2;
(function (Elective2) {
    Elective2["eee4143"] = "eee4143";
    Elective2["eee4163"] = "eee4163";
    Elective2["eee4183"] = "eee4183";
})(Elective2 || (Elective2 = {}));
function isValidStudentInfo(student) {
    return (student.roll.length === 7 &&
        ...
        Object.values(Elective1).includes(student.elective1) &&
        Object.values(Elective2).includes(student.elective2));
}
function submitStudentInfo() {
    const studentInfo = {
        roll: document.getElementById("roll").value,
        elective1: document.querySelector('input[name="elective1"]:checked').value,
        elective2: document.querySelector('input[name="elective2"]:checked').value,
    };
    if (!isValidStudentInfo(studentInfo)) {
        document.getElementById("roll").focus();
        return;
    }
    const cookie = `studentInfo=${JSON.stringify(studentInfo)}; expires=1 Sep 2023 00:00:00 UTC+6`;
    console.log(cookie);
...
if (studentInfo === undefined) {
    ...
    const routine = mandatoryClasses[studentInfo.section]
        ...
        .concat(electiveClasses[studentInfo.elective1][weekday].map(toMandatory(studentInfo.elective1)))
        .concat(electiveClasses[studentInfo.elective2][weekday].map(toMandatory(studentInfo.elective2))))
        .map((day) => day
